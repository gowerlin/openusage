...
- [x] 若有視覺變更，提供 before / after screenshots。（T0016 未新增視覺變更；已提供 current zh-TW browser smoke screenshot）
...
- [ ] 等 Tauri runtime reload persistence smoke 後，才能將 PLAN-002 標為 DONE。
